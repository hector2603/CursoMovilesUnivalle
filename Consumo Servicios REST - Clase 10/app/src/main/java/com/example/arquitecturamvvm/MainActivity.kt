...
import com.example.arquitecturamvvm.searchmovie.SearchMovie
import com.example.arquitecturamvvm.searchmovie.SearchMovieViewModel
        ...
        setContent {
            ArquitecturaMVVMTheme {
                ...
                NavHost(navController = navController, startDestination = starDestination) {
                    ...
                    composable("searchmovie") { SearchMovie(navController, SearchMovieViewModel()) }
                }
            }
        }
    }
